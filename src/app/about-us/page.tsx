...
import { FaLinkedin, FaTwitter, FaCheck, FaLightbulb, FaHandshake, FaRocket, FaGlobe, FaChartLine } from 'react-icons/fa6'
...
const values = [
	{
		...
		description: 'We constantly push boundaries, exploring new technologies to deliver cutting-edge solutions.',
		icon: FaLightbulb,
		className: 'col-span-1 md:col-span-2 lg:col-span-1 bg-primary/5 border-primary/20'
	},
	{
		title: 'Client Partnership',
		description: 'We view ourselves as your long-term partners, not just service providers.',
		icon: FaHandshake,
		className: 'col-span-1 md:col-span-1 lg:col-span-1 bg-card border-border/40'
	},
	{
		title: 'Global Standards',
		description: 'World-class code quality and best practices in every single project.',
		icon: FaGlobe,
		className: 'col-span-1 md:col-span-1 lg:col-span-1 bg-card border-border/40'
	},
	{
	...
	},
	{
		...
		icon: FaRocket,
		className: 'col-span-1 md:col-span-2 lg:col-span-2 bg-gradient-to-r from-primary/10 to-transparent border-primary/20'
	}
]
			...
			<section className='relative pt-32 pb-20 overflow-hidden'>
				...
				<div className='max-w-[1440px] mx-auto px-[20px] md:px-[80px] relative z-10 text-center'>
					...
					<h1 className='text-4xl md:text-6xl font-extrabold tracking-tight mb-8 leading-tight'>
						...
						<span className='text-muted-foreground'>of Digital Experiences</span>
					</h1>
					<p className='text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-12'>
						Reve Infotech is a global technology agency dedicated to transforming ambitious ideas into reality.
						We combine technical excellence with creative innovation to build software that matters.
					</p>
			...
			<section className='py-24'>
				<div className='max-w-[1440px] mx-auto px-[20px] md:px-[80px]'>
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
						<div>
							<h2 className='text-3xl md:text-4xl font-bold mb-8'>We are not just coders, <br /><span className='text-primary'>we are creators.</span></h2>
							<div className='space-y-6 text-muted-foreground text-lg leading-relaxed'>
								<p>
									Founded with a clear vision to bridge the gap between complex technology and human-centric design,
									Reve Infotech has grown from a small team of passionate developers into a full-service digital agency.
								</p>
								<p>
									We believe that every line of code should serve a purpose. Whether it's a startup looking to disrupt the market
									or an enterprise seeking digital transformation, we approach every project with the same level of dedication and precision.
								</p>
								<ul className='space-y-4 mt-8'>
									{['Transparent Communication', 'Agile Methodology', 'Continuous Innovation'].map((item, i) => (
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4'>
							{values.map((val, i) => (
								<div key={i} className={`p-8 rounded-3xl border ${val.className} hover:scale-[1.02] transition-transform duration-300`}>
			...
			<section className='py-24 bg-background'>
				<div className='max-w-[1440px] mx-auto px-[20px] md:px-[80px]'>
					<div className='text-center mb-16'>
						<h2 className='text-3xl md:text-5xl font-bold mb-6'>Meet The <span className='text-primary'>Team</span></h2>
						<p className='text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto'>
							The diverse group of thinkers, makers, and problem-solvers behind our success.
						</p>
					</div>

					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
						{team.map((member, i) => (
							<div key={i} className='group relative bg-card border border-border/40 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300'>
								<div className='aspect-square relative bg-secondary/50'>
									...
									<div className='absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center'>
										<div className='flex gap-4'>
											<Link href='#' className='p-3 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white hover:text-black transition-all'>
						...
						<div className='group flex flex-col items-center justify-center p-8 text-center bg-gradient-to-br from-primary/5 to-transparent border-2 border-dashed border-primary/20 rounded-[32px] hover:bg-primary/5 transition-all cursor-pointer'>
							...
							<p className='text-muted-foreground mb-6'>We are always looking for talent.</p>
				...
				<div className='max-w-[1440px] mx-auto px-[20px] md:px-[80px]'>
					<div className='relative rounded-[48px] bg-primary overflow-hidden px-8 py-20 text-center'>
						...
						<div className='relative z-10 max-w-2xl mx-auto'>
							...
							<Link href='/contact' className='inline-flex items-center gap-2 h-14 px-8 bg-white text-primary rounded-full text-lg font-bold hover:scale-105 transition-transform'>
								Start a Project
